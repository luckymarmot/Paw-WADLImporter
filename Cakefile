...
file = 'WADLImporter_private.coffee'
identifier = 'com.luckymarmot.PawExtensions.WADLImporter'
...
build_copy = () ->
    ...
    fs.writeFileSync "#{ build_dir }/WADLImporter.js", fs.readFileSync("./WADLImporter.js")
    fs.writeFileSync "#{ build_dir }/tv4.js", fs.readFileSync("./node_modules/tv4/tv4.js")
    fs.writeFileSync "#{ build_dir }/api-spec-converter.js", fs.readFileSync("./api-spec-converter.js")
